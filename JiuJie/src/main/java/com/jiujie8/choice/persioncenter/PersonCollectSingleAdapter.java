 ...
 *
 */
public class PersonCollectSingleAdapter extends SingleTypeAdapter<ChoiceMode> {
    ...
    @Inject
    public PersonCollectSingleAdapter(Activity activity) {
        super(activity, R.layout.layout_adapter_personcollect);
    ...
    protected void update(int position, final ChoiceMode item) {
        ...
        view(ROOT).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                activity.startActivityForResult(new Intent(activity, JiuJieDetailActivity.class).putExtras(mBundle), IConstant.SELF_COLLECT_CODE);
            }
        });
        if (item != null) {
