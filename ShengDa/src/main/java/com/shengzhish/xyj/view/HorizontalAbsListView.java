 ...
 */
public abstract class HorizontalAbsListView extends AdapterView<ListAdapter> implements TextWatcher,
        ViewTreeObserver.OnGlobalLayoutListener, Filter.FilterListener,
        ViewTreeObserver.OnTouchModeChangeListener {

	private static final String TAG = HorizontalAbsListView.class.getSimpleName();
...
//    int mMotionViewOriginalTop;
    ...
    /**
     * The last scroll state reported to clients through {@link com.shengzhish.xyj.view.HorizontalAbsListView.OnScrollListener}.
     */
    ...
    public interface OnScrollListener {
         ...
         */
        public void onScroll(HorizontalAbsListView view, int firstVisibleItem, int visibleItemCount,
                             int totalItemCount);
    }
...
//        a.recycle();
    ...
    public HorizontalAbsListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0 /*com.android.internal.R.attr.absListViewStyle bysong*/);
    }

    public HorizontalAbsListView(Context context, AttributeSet attrs, int defStyle) {
...
//            mFastScroller.onScroll(this, mFirstPosition, getChildCount(), mItemCount);
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        /**
         * Constructor called from {@link com.socialtv.view.HorizontalAbsListView#onSaveInstanceState()}
         */
...
//        super.setFrame(left, top, right, bottom);
        changed = ReflectUtil.view_setFrame(ReflectUtil.class.getSuperclass().cast(View.class), HorizontalAbsListView.class.getSuperclass().getSuperclass().getSuperclass(), left, top, right, bottom);
...
//            mGroupFlags |= CLIP_TO_PADDING_MASK;
    ...
    private boolean performLongPress(final View child,
        ...
        if (mOnItemLongClickListener != null) {
            handled = mOnItemLongClickListener.onItemLongClick(HorizontalAbsListView.this, child,
                    longPressPosition, longPressId);
        }
        if (!handled) {
            mContextMenuInfo = createContextMenuInfo(child, longPressPosition, longPressId);
            handled = super.showContextMenuForChild(HorizontalAbsListView.this);
        }
        if (handled) {
    ...
    public boolean showContextMenuForChild(View originalView) {
        ...
        if (longPressPosition >= 0) {
            ...
            if (mOnItemLongClickListener != null) {
                handled = mOnItemLongClickListener.onItemLongClick(HorizontalAbsListView.this, originalView,
                        longPressPosition, longPressId);
            }
            if (!handled) {
