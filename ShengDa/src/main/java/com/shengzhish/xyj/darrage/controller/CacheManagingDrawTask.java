...
package com.shengzhish.xyj.darrage.controller;
...
import com.shengzhish.xyj.darrage.danmaku.model.AbsDisplayer;
import com.shengzhish.xyj.darrage.danmaku.model.BaseDanmaku;
import com.shengzhish.xyj.darrage.danmaku.model.DanmakuTimer;
import com.shengzhish.xyj.darrage.danmaku.model.IDanmakuIterator;
import com.shengzhish.xyj.darrage.danmaku.model.IDrawingCache;
...
import com.shengzhish.xyj.darrage.danmaku.model.android.DrawingCache;
import com.shengzhish.xyj.darrage.danmaku.model.android.DrawingCachePoolManager;
import com.shengzhish.xyj.darrage.danmaku.model.objectpool.Pool;
import com.shengzhish.xyj.darrage.danmaku.model.objectpool.Pools;
import com.shengzhish.xyj.darrage.danmaku.parser.DanmakuFactory;
import com.shengzhish.xyj.darrage.danmaku.util.DanmakuUtils;
...
//Log.e("cache", "break at push failed:" + mMaxSize);
        ...
        @Override
        public void onDanmakuConfigChanged(DanmakuGlobalConfig config, DanmakuGlobalConfig.DanmakuConfigTag tag,
                Object... values) {
            if (tag == null || tag.equals(DanmakuGlobalConfig.DanmakuConfigTag.MAXIMUM_NUMS_IN_SCREEN)) {
                return;
            }
            if (tag.equals(DanmakuGlobalConfig.DanmakuConfigTag.SCROLL_SPEED_FACTOR)) {
            ...
            if (tag.equals(DanmakuGlobalConfig.DanmakuConfigTag.SCALE_TEXTSIZE)) {
                mDisp.resetSlopPixel(DanmakuGlobalConfig.DEFAULT.scaleTextSize);
            }
            if (tag.equals(DanmakuGlobalConfig.DanmakuConfigTag.TRANSPARENCY) || tag.equals(DanmakuGlobalConfig.DanmakuConfigTag.SCALE_TEXTSIZE)) {
