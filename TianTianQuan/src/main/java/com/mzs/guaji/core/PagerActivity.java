...
/**
 * Activity that displays a {@link android.support.v4.view.ViewPager} and has workarounds for
 * ActionBar/ViewPager bugs
 */
public abstract class PagerActivity extends ThirdPartyShareActivity implements
