...
public class PersonalFollowAdapter extends BaseAdapter{
    ...
    private long userId;
	public PersonalFollowAdapter(Context context, List<User> mUsers, LinearLayout mRootLayout) {
        this.userId = userId;
     ...
     * 发送广播,通知粉丝列表刷新
     */
    private void sendFansBroadcast() {
        Intent mIntent = new Intent(BroadcastActionUtil.REFRESHFANSACTION);
        context.sendBroadcast(mIntent);
    }
