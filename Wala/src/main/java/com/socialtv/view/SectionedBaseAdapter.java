...
public abstract class SectionedBaseAdapter extends MultiTypeAdapter implements PinnedHeaderListView.PinnedSectionedHeaderAdapter {

    protected static int HEADER_VIEW_TYPE = 0;
    protected static int ITEM_VIEW_TYPE = 0;
    ...
    public SectionedBaseAdapter(final Activity activity) {
        super(activity);
