...
public class PinnedHeaderListView extends ListView implements OnScrollListener {
    ...
    public static abstract class OnItemClickListener implements android.widget.AdapterView.OnItemClickListener {
        @Override
        public void onItemClick(android.widget.AdapterView<?> adapterView, View view, int rawPosition, long id) {
        ...
        public abstract void onItemClick(android.widget.AdapterView<?> adapterView, View view, int section, int position, long id);
