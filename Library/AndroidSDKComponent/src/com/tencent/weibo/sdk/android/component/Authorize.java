...
public class Authorize extends Activity {
	...
	public void jumpResultParser(String result) {
		...
		if (accessToken != null && !"".equals(accessToken)) {
            ...
            Intent mIntent = new Intent("com.tencent.sso.AUTH");
            mIntent.putExtra("com.tencent.sso.PACKAGE_NAME", getPackageName());
            mIntent.putExtra("com.tencent.sso.AUTH_RESULT", true);
            mIntent.putExtra("com.tencent.sso.WEB", true);
