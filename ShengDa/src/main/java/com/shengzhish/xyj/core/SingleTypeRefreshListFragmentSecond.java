 ...
 */
public abstract class SingleTypeRefreshListFragmentSecond<E> extends PullToRefreshItemListFragment<E> implements LoaderManager.LoaderCallbacks<E>, PullToRefreshBase.OnRefreshListener<ListView>, PullToRefreshBase.OnLastItemVisibleListener {
     ...
     */
    protected SingleTypeRefreshListFragmentSecond<E> notifyDataSetChanged() {
     ...
     * @return this fragment
     */
    protected SingleTypeRefreshListFragmentSecond<E> setListAdapter(final ListAdapter adapter) {
        if (listView != null)
