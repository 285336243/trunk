...
package com.shengzhish.xyj.view;
...
public class HorizontalListView extends HorizontalAbsListView {
    ...
    public HorizontalListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                /*com.android.internal.*/R.styleable.HorizontalListView, defStyle, 0);

        CharSequence[] entries = a.getTextArray(
        		/*com.android.internal.*/R.styleable.HorizontalListView_entries);
        if (entries != null) {
            setAdapter(new ArrayAdapter<CharSequence>(context,
            		/*com.android.internal.*/android.R.layout.simple_list_item_1, entries));
        }

        final Drawable d = a.getDrawable(/*com.android.internal.*/R.styleable.HorizontalListView_divider);
        if (d != null) {
        ...
        final int dividerHeight = a.getDimensionPixelSize(
        		/*com.android.internal.*/R.styleable.HorizontalListView_dividerWidth, 0);
        if (dividerHeight != 0) {
            setDividerHeight(dividerHeight);
        }

        setChoiceMode(a.getInt(R.styleable.HorizontalListView_choiceMode, CHOICE_MODE_NONE));
        
        mHeaderDividersEnabled = a.getBoolean(R.styleable.HorizontalListView_headerDividersEnabled, true);
        mFooterDividersEnabled = a.getBoolean(R.styleable.HorizontalListView_footerDividersEnabled, true);
...
//                    sel.offsetTopAndBottom(childrenLeft - sel.getTop());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DEBUG_MEASURE) {
        	Log.d(TAG, "onMeasure(). W: " + View.MeasureSpec.toString(widthMeasureSpec)
        			+ " H: " + View.MeasureSpec.toString(heightMeasureSpec));
        }
    ...
    final int measureWidthOfChildren(int heightMeasureSpec, int startPosition, int endPosition,
        ...
        final HorizontalAbsListView.RecycleBin recycleBin = mRecycler;
...
//                getChildAt(i).offsetTopAndBottom(widthDelta);
     ...
     * an {@link com.shengzhish.xyj.view.HorizontalListView.ArrowScrollFocusResult}, otherwise, return null.
     *
     * @param direction either {@link android.view.View#FOCUS_UP} or
     *        {@link android.view.View#FOCUS_DOWN}.
...
//                offsetChildrenTopAndBottom(listBottom - last.getBottom());
            ...
            while (first.getRight() < listLeft) {
                HorizontalAbsListView.LayoutParams layoutParams = (LayoutParams) first.getLayoutParams();
...
//                offsetChildrenTopAndBottom(listTop - first.getTop());
            ...
            while (last.getLeft() > listRight) {
                HorizontalAbsListView.LayoutParams layoutParams = (LayoutParams) last.getLayoutParams();
                if (recycleBin.shouldRecycleViewType(layoutParams.viewType)) {
...
//                if (!v.isRootNamespace()) {
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        /**
         * Constructor called from {@link com.socialtv.view.HorizontalListView#onSaveInstanceState()}
         */
