...
import com.shengzhish.xyj.darrage.controller.DanmakuFilters;
import com.shengzhish.xyj.darrage.danmaku.model.AlphaValue;
...
public class DanmakuGlobalConfig {
    ...
    private void setFilterData(String tag, Object data) {
        DanmakuFilters.IDanmakuFilter filter = DanmakuFilters.getDefault().get(tag);
        filter.setData(data);
    }
