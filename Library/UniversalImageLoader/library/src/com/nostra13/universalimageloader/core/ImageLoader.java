...
public class ImageLoader {
    ...
    public File loadImageFileSync(String uri) {
        checkConfiguration();

        ImageLoadingInfo imageLoadingInfo = new ImageLoadingInfo(uri, null, null, null,
                configuration.defaultDisplayImageOptions, null, null, engine.getLockForUri(uri));

        LoadAndDisplayImageTask displayTask = new LoadAndDisplayImageTask(engine, imageLoadingInfo,
                defineHandler(configuration.defaultDisplayImageOptions));

       return displayTask.tryLoadFile();
    }
