 ...
 * 主页的fragment
 */
public class HomeFragment extends DialogFragment implements OnRefreshListener {
...
//    @Inject
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        final int height = ((HomeActivity) getActivity()).mToolbarView.getMeasuredHeight();
...
//                .useViewDelegate(ListView.class, new AbsListViewDelegate())
    ...
    private HomeFragment hide(final View view) {
        ViewUtils.setGone(view, true);
        return this;
    }

    private HomeFragment show(final View view) {
        ViewUtils.setGone(view, false);
        return this;
    }

    private HomeFragment fadeIn(final View view, final boolean animate) {
        if (view != null) {
            if (animate) {
