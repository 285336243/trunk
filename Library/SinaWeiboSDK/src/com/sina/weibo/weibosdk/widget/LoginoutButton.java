...
package com.sina.weibo.weibosdk.widget;
...
import com.sina.weibo.weibosdk.R;
...
import com.sina.weibo.weibosdk.openapi.LogoutAPI;
...
public class LoginoutButton extends Button implements OnClickListener {
	...
	/**
	 * 调用 {@link com.sina.weibo.weibosdk.openapi.LogoutAPI#logout(RequestListener)} 来注销。
	 */
	private void logout() {
		if (mAccessToken != null && mAccessToken.isSessionValid()) {
