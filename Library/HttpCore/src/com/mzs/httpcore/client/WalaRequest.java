...
import com.mzs.httpcore.util.UrlUtils;
...
public class WalaRequest {
	 ...
	 * @return this request
	 */
	public WalaRequest setArrayType(Type arrayType) {
	 ...
	 * @return this request
	 */
	public WalaRequest setUri(StringBuilder uri) {
	 ...
	 * @return this request
	 */
	public WalaRequest setUri(String uri) {
		this.uri = uri;
		return this;
	}
	 ...
	 * @return this request
	 */
	public WalaRequest setParams(Map<String, String> params) {
		this.params = params;
		return this;
	}
	 ...
	 * @return this request
	 */
	public WalaRequest setType(Type type) {
		this.type = type;
		return this;
	}
	 ...
	 * @return this request
	 */
	public WalaRequest setResponseContentType(String responseContentType) {
	...
	public boolean equals(final Object obj) {
		if (obj == this)
			return true;
		if (!(obj instanceof WalaRequest))
			return false;
		final String fullUri = generateUri();
		final String objUri = ((WalaRequest) obj).generateUri();
