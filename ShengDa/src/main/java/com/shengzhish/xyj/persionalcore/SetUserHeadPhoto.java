...
import com.shengzhish.xyj.util.StorageUtil;
...
public class SetUserHeadPhoto extends DialogFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "ShengDa");
    ...
    protected void onDestroy() {
        ...
        String path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/ShengDa";
