...
import com.jiujie8.choice.util.ImageBlur;
...
public class BlurDialogEngine {
    ...
    private void blur(Bitmap bkg, View view) {
        ...
        try {
            if (mHoldingActivity instanceof SherlockFragmentActivity) {
                ActionBar supportActionBar
                        = ((SherlockFragmentActivity) mHoldingActivity).getSupportActionBar();
        ...
        overlay = ImageBlur.doBlurJniBitmap(overlay, 10, true);
