...
package com.shengzhish.xyj.darrage.danmaku.model.android;

import com.shengzhish.xyj.darrage.danmaku.model.BaseDanmaku;
import com.shengzhish.xyj.darrage.danmaku.model.Danmaku;
...
public class Danmakus implements IDanmakus {
    ...
    public void addItems(List<BaseDanmaku> it) {
        synchronized (object) {
            if (items != null) {
                for(BaseDanmaku item:it) {
                    if (items.add(item))
                        mSize++;
                }
            }
    ...
    public IDanmakus sub(long startTime, long endTime) {
        synchronized (object) {
            ...
            Danmakus subItems = new Danmakus();
            if (startItem == null) {
