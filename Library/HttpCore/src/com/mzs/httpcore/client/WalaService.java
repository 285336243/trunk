...
import static com.mzs.httpcore.client.PagedRequest.PAGE_FIRST;
import static com.mzs.httpcore.client.PagedRequest.PAGE_SIZE;
 ...
 */
public abstract class WalaService {
	 ...
	 * Client field
	 */
	protected final WalaClient client;

	/**
	 * Create service using a default {@link WalaClient}
	 */
	public WalaService() {
		this(new WalaClient());
	}
	 ...
	 *            must be non-null
	 */
	public WalaService(WalaClient client) {
		if (client == null)
	 ...
	 * @return request
	 */
	protected WalaRequest createRequest() {
		return new WalaRequest();
	}
	 ...
	 * @return this service
	 */
	protected WalaService verifyRepository(String user, String repository) {
		if (user == null)
